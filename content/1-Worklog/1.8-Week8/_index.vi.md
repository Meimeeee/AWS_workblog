...
### Nội dung công việc trọng tâm Tuần 8

Trọng tâm của tuần này là bắt đầu triển khai dự án thực tế bằng cách phát triển mã nguồn và tích hợp các dịch vụ AWS cốt lõi vào hệ thống.
...
- Thực thi ứng dụng thử nghiệm trên **Amazon EC2**
